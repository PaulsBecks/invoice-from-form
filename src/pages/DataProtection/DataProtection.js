  ...
  return (
    <div>
      <div className="invoice-app-container">
        ...
        <h2>Datenschutz</h2>
        <p>
          Wir haben diese Datenschutzerklärung (Fassung 04.06.2020-311183069)
        ...
        <h3 data-fontsize="21" data-lineheight="31">
        ...
        <p>
          ...
          gesprochen sind es HTTP-Cookies, da es auch noch andere&nbsp;Cookies
          für andere Anwendungsbereiche gibt. HTTP-Cookies&nbsp;sind kleine
          Dateien, die von unserer Website auf Ihrem Computer gespeichert
          werden. Diese Cookie-Dateien werden automatisch im Cookie-Ordner,
          quasi dem “Hirn” Ihres Browsers, untergebracht. Ein Cookie besteht aus
        ...
        <p>
          ...
          beispielsweise Sprache oder persönliche Seiteneinstellungen. Wenn Sie
          unsere Seite wieder aufrufen, übermittelt Ihr Browser die
          „userbezogenen“ Informationen an unsere Seite zurück. Dank der Cookies
          weiß unsere Website, wer Sie sind und bietet Ihnen Ihre gewohnte
          Standardeinstellung. In einigen Browsern hat
        ...
        <ul>
          ...
          <li>Beispielhafter Wert:&nbsp;GA1.2.1326744211.152311183069</li>
        </ul>
        ...
        <p>
          ...
          <br />
          <strong>Wert:</strong>2.1326744211.152311183069-5
          <br />
        ...
        <p>
          ...
          <br />
          <strong>Wert:</strong>2.1687193234.152311183069-1
          <br />
        ...
        <p>
          ...
          auf Vollständigkeit erheben, da Google die Wahl seiner Cookies immer
          wieder verändert.
        </p>
        <p>
        ...
        <p>
          ...
          >
            https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;tid=311183069
          </a>
